        ...
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="接入类型">
            <el-select v-model="form.type" placeholder="请选择接入类型">
              <el-option label="商机号-中间号" value="商机号-中间号"></el-option>
              <el-option label="商机号-专号" value="商机号-专号"></el-option>
              <el-option label="商机号-中间号+专号" value="商机号-中间号+专号"></el-option>
              <el-option label="SDK" value="SDK"></el-option>
              <el-option label="SDK+商机号-中间号" value="SDK+商机号-中间号"></el-option>
              <el-option label="SDK+商机号-专号" value="SDK+商机号-专号"></el-option>
              <el-option label="SDK-中间号+专号" value="SDK-中间号+专号"></el-option>
              <el-option label="SIP标类" value="SIP标类"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="接入状态">
            <el-select v-model="form.client_status" placeholder="请选择接入状态">
